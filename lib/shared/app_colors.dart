...
class AppColors {
  static const Color black50 = Color(0xFF121212);
  static const Color black100 = Color(0xFF373737);

  static const Color primary50 = Color(0xFFFAF8FF);
  ...
  static const Color grey350 = Color(0xFFCECCCC);
